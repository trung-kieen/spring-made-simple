...
public class AuthenticationServiceImpl implements AuthenticationService {
  ...
  private UrlContextBuilder urlBuilder;


  @Autowired
  public AuthenticationServiceImpl(PasswordEncoder passwordEncoder, RoleRepository roleRepository,
      TokenService tokenService, UserRepository userRepository, EmailSenderService emailSenderService,
      AuthenticationManager authenticationManager, JwtTokenUtil jwtTokenUtil, UrlContextBuilder urlBuilder      ) {
