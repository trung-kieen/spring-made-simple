 ...
 */
public abstract class BaseAbstractService<T extends BaseEntity<T>, U extends Serializable, K extends IBaseRepository<T, U>>
    implements BaseService<T, U> {

  @Autowired
  protected IBaseRepository<T, U> baseRepository;
